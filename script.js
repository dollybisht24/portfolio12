...
console.log('%c💼 Looking for a passionate developer? Let\'s connect!', 'color: #764ba2; font-size: 14px;');
console.log('%c📧 dollybisht408@gmail.com', 'color: #ec4899; font-size: 14px;');
